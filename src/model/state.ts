...
// Holds the pending follow requests loaded from the user's JSON export.
// The CancelRequests component owns the rest of the cancel sub-flow internally
// (id resolution, verification, selection, cancellation, progress, ETA).
